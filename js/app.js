...
function createDrinks() {
  ...
  new Drink("Reindeer RAM", "Boost memories of your big day with this elegant peppermint martini!", "Vodka", ["Vodka", "Candy Canes", "Marshmallow Creme"], "Winter", "Wedding", "./images/anvay-pinkfizz.png", "Crush peppermint, swirl, and serve.", "Author - Jessica P.");
  ...
  new Drink('HTML Button', 'A classic White Russian cocktail.', 'Vodka', ['Vodka', 'Coffee Liqueur', 'Cream or Milk'], 'Winter', 'Night-out', "./images/matt-moscow.png", 'Add 2 parts Vodka, 1 part coffee liqueur, and 1 part cream.', 'Author - Matt C.');
  ...
  new Drink('GuavaScript', 'If (let feeling === good) {getThisDrink();}', 'Tequila', ['Guava Nectar', 'Tequila', 'Lime', 'Mint'], 'Summer', "Night-out", "./images/jess-pineapple.png", 'Mix Lime Juice, Tequila, and Guava Nectar in 1:2:6 ratio. Garnish with mint and lime slice.', 'Author - Matt C.');
  ...
  new Drink("Python Paloma", "Enjoying this delicious treat is fun in any language!", "Tequila", ["Tequila", "Pink Grapefruit", "Lime Juice", "Coarse Salt"], "Autumn", "Night-out", "./images/jess-Coconut.png", "Press grapefruit, squeeze lime, and mix well.", "Author - Jessica P.");
  ...
  new Drink("Smoking See SS", "Get spooky with this gruesome Halloween mocktail.", "Non-Alcoholic Mixer", ['Non-Alcoholic Mixer', "Cranberry Juice", "Apple Cider", "Dry Ice"], "Autumn", "Night-out", "./images/jess-eyeball.png", "Shake, stir, and dive in!", "Author - Jessica P.");
    
  new Drink('Mistletoe Mimosa', 'Make this holiday all holly-jolly with this Christmas cocktail!', 'Non-Alcoholic Mixer', ["Barley Tea", "Maple Syrup", "Mistletoe Magic"], 'Winter', 'Holiday', "./images/anvay-Champagne.png", "Mix the strong tea with syrup and find someone for that final ingredient ;) ", "Author, - Anvay B");

  new Drink('Git Pulled Wine', 'A warm drink for a happy occasion.', 'Non-Alcoholic Mixer', ['Non-Alcoholic Mixer', 'Grape Juice', 'Orange', 'Star Anise', 'Cinnamon Sticks'], 'Winter', 'Wedding', "./images/matt-mulled.png", 'In a large oven, warm a bottle of grape juice with sliced oranges, star anise, and cinnamon sticks.', 'Author - Matt C.')
    
  new Drink('The Wonderful Blizzard of Oz', 'Follow your heart and freeze your brain!', 'Non-Alcoholic Mixer', ['Non-Alcoholic Mixer', '5 oz Pineapple Juice', '2 oz Coconut Cream', '1 Banana'], 'Winter', 'Night-out', "./images/jess-bluemartini.png", 'Add the ingredients, plus a handful of ice, to a blender. Blend until smooth, and pour into a rocks or highball glass.', 'Author - Robert Z');
}
